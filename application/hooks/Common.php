...
class _Common
{
	...
	function init()
	{
		...
		if (empty($CI->uri->segment(1)) || $CI->uri->segment(1) === 'main' || $CI->uri->segment(1) === 'board' || $CI->uri->segment(1) === 'post' || $CI->uri->segment(1) === 'search' || $CI->uri->segment(1) === 'stat' || $CI->uri->segment(1) === 'group' || $CI->uri->segment(1) === 'fcm') 
            required_user_login();
		...
		if ($CI->member->is_admin() !== 'super'
			&& ($CI->uri->segment(1) === config_item('uri_segment_admin') || $CI->uri->segment(1) === 'fcm')) {
