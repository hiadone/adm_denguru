 ...
 */
class Trashcmallitem extends CB_Controller
{
     ...
     * 페이지 이동시 필요한 정보입니다
     */
    public $pagedir = 'cmall/trashcmallitem';
    ...
    {
        // 이벤트 라이브러리를 로딩합니다
        $eventname = 'event_admin_cmall_trashcmallitem_index';
    ...
    {
        // 이벤트 라이브러리를 로딩합니다
        $eventname = 'event_admin_cmall_trashcmallitem_write';
        $this->load->event($eventname);
    ...
    {
        // 이벤트 라이브러리를 로딩합니다
        $eventname = 'event_admin_cmall_trashcmallitem_listdelete';
        $this->load->event($eventname);
