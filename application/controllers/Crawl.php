                                        ...
                                        if ($uploadfiledata
                                            ...
                                            foreach ($uploadfiledata as $pkey => $pval) {
                                               if ($pval) {
                                                   ...
                                                   if(element('bca_parent',$category) =="1"|| element('bca_key',$category)=="1"){
                                                       if(element('cfi_filename', $pval) && filesize(config_item('uploads_dir') . '/cmallitem/' . element('cfi_filename', $pval)) < 5020868) {
