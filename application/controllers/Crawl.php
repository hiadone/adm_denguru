                            ...
                            foreach($this->tag_word as $word){
                                foreach ($tag_array as $tval) {
                                    ...
                                    if(count($arr_str) > 2 || $s2flag){
                                        ...
                                        if(strtolower(element('tgw_value',$word)) === strtolower($tval) || preg_match("/[\s?\[?\-?]".preg_quote(element('tgw_value',$word),'/')."[\]?\s?\-?]|^".preg_quote(element('tgw_value',$word),'/')."[\s\]]|[\s?\[?\-?]".preg_quote(element('tgw_value',$word),'/')."$/i",$tval)){
                                            if(!in_array(strtolower(element('tgw_value',$word)),$translate_text))
                                                array_push($translate_text,strtolower(element('tgw_value',$word)));
                                        }     
                                    }
            ...
            foreach($crawl_tag_text as $t_value){
                ...
                if($flag){
                    ...
                    if(count($arr_str_kr) > 2){
                        ...
                        if(strtolower($c_value) === strtolower($t_value) || preg_match("/[\s?\[?\-?]".preg_quote($c_value,'/')."[\]?\s?\-?]|^".preg_quote($c_value,'/')."[\s\]]|[\s?\[?\-?]".preg_quote($c_value,'/')."$/i",$t_value))
                         return true;
                    }
        ...
        if (element('list', $result)) {
            foreach (element('list', $result) as $key => $val) {
                ...
                // }else {
                    ...
                    $data['list'][$key]['brd_crawl_comment'] = element('brd_crawl_comment',$val);                  
                // }
...
// exit;
    ...
    public function insert_itemlist($brd_id = 0,$crw_id = 0)
    {
        ...
        if(empty($crw_id)){
            ...
            if(strpos(str_replace(" ","",$crw_category1),'고양이') !==false || strpos(str_replace(" ","",$crw_category2),'고양이') !==false || strpos(str_replace(" ","",$crw_category3),'고양이') !==false){
            ...
            if($brd_id == '24'){
                if(strpos(strtolower(str_replace(" ","",$crw_category1)),strtolower('brand')) !==false){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '82'){
                if(strpos(str_replace(" ","",$crw_category1),'브랜드') !==false || strpos(str_replace(" ","",$crw_category1),'공부하는') !==false){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '94'){
                if(strpos(strtolower(str_replace(" ","",$crw_category1)),strtolower('KNITTING')) !==false){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '105'){
                if(strpos(strtolower(str_replace(" ","",$crw_category1)),strtolower('캣사료')) !==false ){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '115'){
                if(strpos(strtolower(str_replace(" ","",$crw_category1)),strtolower('EVENT-EVENT')) !==false){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '132'){
                if(strpos(strtolower(str_replace(" ","",$crw_category1)),strtolower('PERSONAL')) !==false){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '137'){
                if(strpos(strtolower(str_replace(" ","",$crw_category1)),strtolower('cat')) !==false){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '140'){
                if(strpos(str_replace(" ","",$crw_category1),'도매결제') !==false){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '144'){
                if(strpos(strtolower(str_replace(" ","",$crw_category1)),strtolower('forDOG')) ===false && strpos(strtolower(str_replace(" ","",$crw_category2)),strtolower('forDOG')) ===false ){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '150'){
                if(strpos(strtolower(str_replace(" ","",$crw_category1)),strtolower('BABY')) !==false || strpos(strtolower(str_replace(" ","",$crw_category1)),strtolower('BEDDING')) !==false ){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '165'){
                if(strpos(strtolower(str_replace(" ","",$crw_category1)),strtolower('브랜드')) !==false ){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '168'){
                if(strpos(strtolower(str_replace(" ","",$crw_category2)),strtolower('color')) !==false || strpos(strtolower(str_replace(" ","",$crw_category2)),strtolower('Hashtag')) !==false ){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
             ...
             if($brd_id == '190'){
                if(strpos(strtolower(str_replace(" ","",$crw_category1)),strtolower('반려동물')) ===false ){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '195'){
                if(strpos(strtolower(str_replace(" ","",$crw_category1)),strtolower('반려묘')) !==false ){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '207'){
                if(strpos(strtolower(str_replace(" ","",$crw_category1)),strtolower('개인결제')) !==false ){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '228'){
                if(strpos(strtolower(str_replace(" ","",$crw_category2)),strtolower('all')) !==false ){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '258'){
                if(strpos(strtolower(str_replace(" ","",$crw_category2)),strtolower('브랜드별')) !==false ){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '281'){
                if(strpos(strtolower(str_replace(" ","",$crw_category2)),strtolower('반려동물')) ===false){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '316'){
                if(strpos(strtolower(str_replace(" ","",$crw_category1)),strtolower('클래스')) !==false ){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if(strpos(str_replace(" ","",$updatedata['crw_category1']),'고양이') !==false || strpos(str_replace(" ","",$updatedata['crw_category2']),'고양이') !==false || strpos(str_replace(" ","",$updatedata['crw_category3']),'고양이') !==false ){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '24'){
                if(strpos(strtolower(str_replace(" ","",$updatedata['crw_category1'])),strtolower('brand')) !==false){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '82'){
                if(strpos(str_replace(" ","",$updatedata['crw_category1']),'브랜드') !==false || strpos(str_replace(" ","",$updatedata['crw_category1']),'공부하는') !==false){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '94'){
                if(strpos(strtolower(str_replace(" ","",$updatedata['crw_category1'])),strtolower('KNITTING')) !==false){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '105'){
                if(strpos(strtolower(str_replace(" ","",$updatedata['crw_category1'])),strtolower('캣사료')) !==false ){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '115'){
                if(strpos(strtolower(str_replace(" ","",$updatedata['crw_category1'])),strtolower('EVENT-EVENT')) !==false){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '132'){
                if(strpos(strtolower(str_replace(" ","",$updatedata['crw_category1'])),strtolower('PERSONAL')) !==false){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '137'){
                if(strpos(strtolower(str_replace(" ","",$updatedata['crw_category1'])),strtolower('cat')) !==false){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '140'){
                if(strpos(str_replace(" ","",$updatedata['crw_category1']),'도매결제') !==false){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '144'){
                if(strpos(strtolower(str_replace(" ","",$updatedata['crw_category1'])),strtolower('forDOG')) ===false && strpos(strtolower(str_replace(" ","",$updatedata['crw_category2'])),strtolower('forDOG')) ===false ){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '150'){
                if(strpos(strtolower(str_replace(" ","",$updatedata['crw_category1'])),strtolower('BABY')) !==false || strpos(strtolower(str_replace(" ","",$updatedata['crw_category1'])),strtolower('BEDDING')) !==false ){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '165'){
                if(strpos(strtolower(str_replace(" ","",$updatedata['crw_category1'])),strtolower('브랜드')) !==false ){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '168'){
                if(strpos(strtolower(str_replace(" ","",$updatedata['crw_category2'])),strtolower('color')) !==false || strpos(strtolower(str_replace(" ","",$updatedata['crw_category2'])),strtolower('Hashtag')) !==false ){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '190'){
                if(strpos(strtolower(str_replace(" ","",$updatedata['crw_category2'])),strtolower('반려동물')) ===false ){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '195'){
                if(strpos(strtolower(str_replace(" ","",$updatedata['crw_category1'])),strtolower('반려묘')) !==false ){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '207'){
                if(strpos(strtolower(str_replace(" ","",$updatedata['crw_category1'])),strtolower('개인결제')) !==false ){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '228'){
                if(strpos(strtolower(str_replace(" ","",$updatedata['crw_category2'])),strtolower('all')) !==false ){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '258'){
                if(strpos(strtolower(str_replace(" ","",$updatedata['crw_category2'])),strtolower('브랜드별')) !==false ){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
            ...
            if($brd_id == '316'){
                if(strpos(strtolower(str_replace(" ","",$updatedata['crw_category1'])),strtolower('클래스')) !==false ){
                    $result = array('resultcode'=>9002,'message' => '불필요한 카테고리 입니다..');
                    exit(json_encode($result,JSON_UNESCAPED_UNICODE));
                }
 ...
 $upload_path .= $brd_id . '/';
    ...
    {   
        ...
        if ( ! element('brd_id', $board_crawl)) {
            log_message('error', 'msg: 없는 brd_id 입니다 pointer:'.current_url());
            show_404();
        }
