...
/**
 * FCM 발송 페이지에 보이는 셀렉트박스
 */
if ( ! function_exists('get_fcm_send_selectbox')) {
	function get_fcm_send_selectbox($config = '', $memberonly = '')
	{
		if (empty($config)) {
			return false;
		}
