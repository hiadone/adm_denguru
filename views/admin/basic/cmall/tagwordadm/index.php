			...
			<div class="collapse in" id="cmalltab3">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						...
						<textarea class="form-control" name="tgw_value_9" id="tgw_value_9" rows="15"><?php echo element('tgw_value_9', element('data', $view)); ?></textarea>
						<div class="help-block">태그 입력(엔터 또는 콤마로 구분하여 입력)</div>
					</div>
				</div>
			...
			<div class="collapse in" id="cmalltab3">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						...
						<textarea class="form-control" name="tgw_value_10" id="tgw_value_10" rows="15"><?php echo element('tgw_value_10', element('data', $view)); ?></textarea>
						<div class="help-block">태그 입력(엔터 또는 콤마로 구분하여 입력)</div>
					</div>
					<div class="col-sm-3">
						<label class="">놀이 장난감 태그사전</label>
						<textarea class="form-control" name="tgw_value_11" id="tgw_value_11" rows="15"><?php echo element('tgw_value_11', element('data', $view)); ?></textarea>
						<div class="help-block">태그 입력(엔터 또는 콤마로 구분하여 입력)</div>
					</div>
					<div class="col-sm-3">
						<label class="">미용·목욕 태그사전</label>
						<textarea class="form-control" name="tgw_value_12" id="tgw_value_12" rows="15"><?php echo element('tgw_value_12', element('data', $view)); ?></textarea>
						<div class="help-block">태그 입력(엔터 또는 콤마로 구분하여 입력)</div>
					</div>
					<div class="col-sm-3">
						<label class="">기타</label>
						<textarea class="form-control" name="tgw_value_13" id="tgw_value_13" rows="15"><?php echo element('tgw_value_13', element('data', $view)); ?></textarea>
						<div class="help-block">태그 입력(엔터 또는 콤마로 구분하여 입력)</div>
					</div>
