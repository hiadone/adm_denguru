						...
						<tr class="<?php echo element('warning', $result) ? 'warning':''; ?> ">
							...
							<td>
								...
								<?php if (element('crw_file_1', $result)) {?>
										...
										<img src="<?php echo thumb_url('crawlitem', element('crw_file_1', $result), 80); ?>" alt="<?php echo html_escape(element('crw_name', $result)); ?>" title="<?php echo html_escape(element('crw_name', $result)); ?>" class="thumbnail mg0 view_full_image" style="width:80px;" data-origin-image-url="<?php echo thumb_url('crawlitem', element('crw_file_1', $result)); ?>"
