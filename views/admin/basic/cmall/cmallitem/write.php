<div class="box">
	<div class="box-table">
		...
		?>
			...
			<div class="box-table-header">
				<h4><a data-toggle="collapse" href="#cmalltab8" aria-expanded="true" aria-controls="cmalltab8">제품특성</a></h4>
			...
			<div class="collapse in" id="cmalltab8">
				<div class="form-group">
					<label class="col-sm-2 control-label">제품특성</label>
					<div class="col-sm-10">
						<?php
						$open = false;
			...
			<?php for ($k = 1; $k<= 10; $k++) { ?>
				<div class="form-group">
					...
					?>
						<img src="<?php echo thumb_url('cmallitem', element('cit_file_' . $k, element('data', $view))); ?>" alt="<?php echo isset($detail) ? html_escape(element('cde_title', $detail)) : ''; ?>" title="<?php echo isset($detail) ? html_escape(element('cde_title', $detail)) : ''; ?>" />
