	...
	?>
		<div class="box-header">
			...
			<ul class="nav nav-tabs">
				...
				<li role="presentation"><a href="<?php echo admin_url($this->pagedir . '/write_category/' . element('bgr_id', element('data', $view))); ?>" onclick="return check_form_changed();">그룹카테고리</a></li>
			</ul>
		</div>
	<?php
	} else {
	?>
		<div class="box-header">
			<ul class="nav nav-tabs">
				...
				<li role="presentation"><a href="javascript:;" onClick="alert('기본정보를 저장하신 후에 다른 정보 수정이 가능합니다');">그룹카테고리</a></li>
